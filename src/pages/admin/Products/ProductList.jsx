                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-5" style={{ borderColor: '#e2e8f0' }}>
                        <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            <input
                                ...
                                style={{ borderColor: '#cbd5e1', paddingLeft: '1rem', paddingRight: '1rem' }}
                                value={searchQuery}
                                ...
                                <table className="table w-full">
                                    ...
                                    <tbody>
                                        {products.map((product) => (
                                            <tr key={product._id} className="hover:bg-gray-50 transition-colors border-b" style={{ borderColor: '#e2e8f0' }}>
                                                <td className="py-3 px-4">
                                                    <div className="avatar">
                                                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded overflow-hidden border" style={{ borderColor: '#e2e8f0' }}>
                                                            <img
                                                    ...
                                                    <div className="font-medium text-xs sm:text-sm" style={{ color: '#1E293B' }}>
                                                        ...
                                                        <div className="md:hidden mt-1">
                                                            <span
                                                                ...
                                                                style={product.type === PRODUCT_TYPES.PHYSICAL ? { backgroundColor: '#6B8E6B', color: '#ffffff', border: 'none' } : { backgroundColor: '#64748b', color: '#ffffff', border: 'none' }}
                                                            >
                                                ...
                                                <td className="py-3 px-4">
                                                    <div className="flex flex-col sm:flex-row gap-2">
                                                        ...
                                                        <Link
                                                            ...
                                                            style={{ borderColor: '#1E293B', color: '#1E293B', paddingLeft: '0.75rem', paddingRight: '0.75rem', paddingTop: '0.375rem', paddingBottom: '0.375rem' }}
                                                        >
                                                            <svg
                                                                className="w-4 h-4"
                                                                fill="none"
