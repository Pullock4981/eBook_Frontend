 ...
 * 
 * Form for user registration with mobile number.
            ...
            <div className="form-control">
                ...
                <input
                    ...
                    {...register('name', {
                        ...
                        minLength: {
                            value: 2,
                            message: t('auth.errors.nameMinLength') || 'Name must be at least 2 characters',
                        },
                    })}
                />
                {errors.name && (
                ...
                <div className="relative">
                    <input
                        ...
                        {...register('password', {
                            ...
                            minLength: {
                                value: 6,
                                message: t('auth.errors.passwordMinLength') || 'Password must be at least 6 characters',
                            },
                        })}
                    />
                    <button
